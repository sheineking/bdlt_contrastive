...
class LearningManager():
    def __init__(self,  model_name=None, encoder="Pairwise_RMS", use_wandb=False):
        """
        ...
        :param encoder:         Name of a pretrained contrastive model
        ...
        print("\n" + "="*50)
        print("       Pretrained Learning ")
        print("="*50)

        print("Preparing the tokenizer...")
        self.tokenizer = AutoTokenizer.from_pretrained(m.MODEL_NAME)

        # Load the model as baseline from huggingface and update the weights based on contrastive pre-trained model.
